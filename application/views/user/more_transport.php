    ...
    <div class="box-body">
        ...
        foreach ($more_transports as $latest):
            ...
            <div class="box-title">
                ...
                <span class="glyphicon glyphicon-hand-right"></span> <?php echo $latest[$this->nl->lang_based_data('bn_name', 'name')]; ?>
            </div>
            <hr/>
<?php endforeach ?>
        <a href="<?php echo site_url_tr('search/routes?fd=' . $route['from_district'] . '&ft=' . $route['from_thana'] . '&f=' . $route['from_place'] . '&td=' . $route['to_district'] . '&th=' . $route['to_thana'] . '&t=' . $route['to_place']); ?>" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-eye-open"></span>  <?php echo lang('more_deep'); ?></a>
    </div>
