...
$lang['first_rule'] = 'Site now in <strong>%1$s</strong> mode so you should type in <strong>%1$s</strong>. If want to type in <strong>%2$s</strong> then switch to <strong>%2$s</strong> mode first';
