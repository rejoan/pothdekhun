...
class Transport_model extends CI_Model {
    ...
    public function get_counters($poribohon_id, $district_id, $count = FALSE) {
        ...
        $this->db->join('thanas t', 't.id = c.thana', 'left');
        $this->db->where('c.poribohon_id', $poribohon_id);
