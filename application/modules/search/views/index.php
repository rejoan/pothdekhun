...
<div id="route_detail" class="col-sm-6 col-sm-push-3">
    <div class="box box-poth">
        ...
        <?php endif; ?>
        <h1>More Result Found for <a href="<?php echo site_url_tr('search/routes/?fd=' . $this->input->get('fd') . '&ft=' . $this->input->get('ft') . '&f=' . $density_from . '&td=' . $this->input->get('td') . '&th=' . $this->input->get('th') . '&t=' . $density_to); ?>"><?php echo $density_from . ' to ' . $density_to; ?><a></h1>
                    </div>
