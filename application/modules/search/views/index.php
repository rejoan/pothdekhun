...
<div id="route_detail" class="col-xs-12 col-md-6">
    <div class="box box-poth">
        <div class="box-header with-border">
            ...
            <?php } else { ?>
                <?php echo '<p>' . lang('transports_of_place') . '</p><span class="label label-info">' . mb_convert_case($this->input->get('sp', TRUE), MB_CASE_TITLE, 'UTF-8') . '</span>'; ?>
            <?php } ?>
        </div>
        <div class="box-body">
            <?php foreach ($routes as $key => $route): ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if ($found_in == 'stoppage' || $found_in == 'suggestion'): ?>
