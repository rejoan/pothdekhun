        ...
        <div class="box box-poth">
            ...
            <div class="box-body">
                <?php foreach ($stoppage_routes as $sr): ?>
                    <div class="panel panel-default">
                        <?php
                        $url_title = $sr[$this->nl->lang_based_data('fp_bn', 'from_place')] . ' ' . lang('to_view') . ' ' . $sr[$this->nl->lang_based_data('tp_bn', 'to_place')] . ' ' . $sr[$this->nl->lang_based_data('bn_name', 'name')];
                        ?>
                        <div class="panel-heading"><h4 class="no-margin"><a class="details" href="<?php echo site_url_tr('routes/show/') . $sr['r_id'] . '/' . unicode_title($url_title); ?>"><?php echo $sr[$this->nl->lang_based_data('bn_name', 'name')]; ?></a>&nbsp;[<?php echo mb_convert_case($sr['transport_type'], MB_CASE_TITLE, 'UTF-8'); ?>] <a class="btn btn-info btn-xs" href="<?php echo site_url_tr('routes/show/') . $sr['r_id']; ?>"><i class="fa fa-eye"></i> <?php echo lang('about_detail'); ?></a></h4></div>
                        <div class="panel-body">
        ...
        <div class="box box-poth">
            ...
            <div class="box-body">
                <?php foreach ($suggested_routes as $sgr): ?>
                    <div class="panel panel-default">
                        <?php
                        $url_title = $sgr[$this->nl->lang_based_data('fp_bn', 'from_place')] . ' ' . lang('to_view') . ' ' . $sgr[$this->nl->lang_based_data('tp_bn', 'to_place')] . ' ' . $sgr[$this->nl->lang_based_data('bn_name', 'name')];
                        ?>
                        <div class="panel-heading"><h4 class="no-margin"><a class="details" href="<?php echo site_url_tr('routes/show/') . $sgr['r_id'] . '/' . unicode_title($url_title); ?>"><?php echo $sgr[$this->nl->lang_based_data('bn_name', 'name')]; ?></a>&nbsp;[<?php echo mb_convert_case($sgr['transport_type'], MB_CASE_TITLE, 'UTF-8'); ?>] <a class="btn btn-info btn-xs" href="<?php echo site_url_tr('routes/show/') . $sgr['r_id']; ?>"><i class="fa fa-eye"></i> <?php echo lang('about_detail'); ?></a></h4></div>
                        <div class="panel-body">
        ...
        <div class="box box-poth">
            ...
            <div class="box-body">
                <?php foreach ($possible_matches as $pr): ?>
                    <div class="panel panel-default">
                        <?php
                        $url_title = $pr[$this->nl->lang_based_data('fp_bn', 'from_place')] . ' ' . lang('to_view') . ' ' . $pr[$this->nl->lang_based_data('tp_bn', 'to_place')] . ' ' . $pr[$this->nl->lang_based_data('bn_name', 'name')];
                        ?>
                        <div class="panel-heading"><h4 class="no-margin"><a class="details" href="<?php echo site_url_tr('routes/show/') . $pr['r_id'] . '/' . unicode_title($url_title); ?>"><?php echo $pr[$this->nl->lang_based_data('bn_name', 'name')]; ?></a>&nbsp;[<?php echo mb_convert_case($pr['transport_type'], MB_CASE_TITLE, 'UTF-8'); ?>] <a class="btn btn-info btn-xs" href="<?php echo site_url_tr('routes/show/') . $pr['r_id']; ?>"><i class="fa fa-eye"></i> <?php echo lang('about_detail'); ?></a></h4></div>
                        <div class="panel-body">
