                ...
                <tbody>
                    <?php foreach ($comments as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a onclick="return confirm('Delete this Comment?');" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Update" href="<?php echo site_url('comments/delete') . '/' . $r['id']; ?>"><i class="fa fa-trash"></i></a>
