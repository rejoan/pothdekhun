                ...
                <tbody>
                    <?php foreach ($poribohons as $r):$segment++; ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" target="_blank" data-toggle="tooltip" data-placement="top" title="Review" href="<?php echo site_url('transports/edit') . '/' . $r['id'] . '?pd_rev=yes'; ?>"><i class="fa fa-link"></i></a>
