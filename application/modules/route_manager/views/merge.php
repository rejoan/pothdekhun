...
<div class="col-xs-12 col-md-6">
    <div class="box box-poth">
        ...
        <div class="box-body">
            ...
            <div id="stoppage_section">
                <?php
                for ($i = 0; $i < count($edited_stoppages); $i++) {
                    $k = $i + 1;
                    echo '<div class="row"><div class="col-xs-10 col-md-2"><input id="position_' . $k . '" maxlength="2" type="text" class="form-control order_pos" name="position[]" value="' . $edited_stoppages[$i]['position'] . '"></div><div class="col-xs-10 col-md-3"><input id="place_' . $k . '" maxlength="150" type="text" class="form-control" name="place_name[]" value="' . $edited_stoppages[$i]['place_name'] . '" placeholder="' . lang('place_name') . '"></div><div class="col-xs-10 col-md-4 margin_top margin-bottom"><textarea id="comment_' . $k . '" maxlength="1000" class="form-control" name="comments[]"  placeholder="' . lang('comment') . '">' . $edited_stoppages[$i]['comments'] . '</textarea></div><div class="col-xs-10 col-md-2"><input id="rent_' . $k . '" maxlength="10" type="text" class="form-control rent" name="rent[]" value="' . $edited_stoppages[$i]['rent'] . '"  placeholder="' . lang('main_rent') . '"></div></div>';
                }
                ?>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo lang('prev_file'); ?></label>
                <div class="col-xs-10 col-md-6">
                    <a id="prev_evidence" href="<?php echo base_url('evidences') . '/' . $edited_route['evidence']; ?>"><?php echo $edited_route['evidence']; ?></a>
                </div>
            </div>
        </div>
    </div>
