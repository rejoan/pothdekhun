...
//add dynamic stoppgae as many user can
    ...
    $("#departure_time").change(function () {
        if ($(this).val() == 2) {
            $("<div id=\"departure_dynamic\" class=\"form-group\"><div class=\"col-md-12\"><textarea id=\"custom_area\" rows=\"7\" class=\"form-control\" name=\"departure_dynamic\">Example:\nMorning : 9 AM\nNight : 10 PM</textarea></div></div>").insertAfter("#departure_perticular").hide().slideDown();
        } else {
